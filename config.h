...
static const char         col_cyan[]  = "#494d21";
...
static const Rule rules[] = {
       ...
       */
      /* class      instance    title       tags mask     isfloating   monitor rx    ry */
      {"Gimp",      NULL, NULL, 0,      1, -1, 0,    0},
      {"Emacs",     NULL, NULL, 0,      1, -1, 2340, 0},
      {"Alacritty", NULL, NULL, 0,      1, -1, 1200, 0},
...
static const char *volup[]     = {"/usr/sbin/pamixer", "-i", "5", NULL};
static const char *voldn[]     = {"/usr/sbin/pamixer", "-d", "5", NULL};
static const char *soff[]      = {"xrandr", "--output", "DP-0", "--brightness", "0", NULL};
static const char *son[]       = {"xrandr", "--output", "DP-0", "--brightness", "1", NULL};
...
static const Key keys[] = {
      ...
      {MODKEY,             XK_comma,  spawn,          {.v = voldn}      },
      {MODKEY | ShiftMask, XK_e,      spawn,          {.v = emacs}      },
      {MODKEY | ShiftMask, XK_d,      spawn,          {.v = soff}       },
      {MODKEY | ShiftMask, XK_s,      spawn,          {.v = son}        },
};
